...
public class AccountResourceTests extends GraphQLTest
{
  ...
  @Test
  @Transactional
  public void testUpdateAccountPicture()
  {
    given()
      .when()
      .auth().oauth2(getEarlsToken())
      .body(getGraphQLBody("graphql/UpdateAccountPicture.graphql").replace("DB_ID", dubinsky.getId().toString()))
      .post("/graphql")
      .then()
      .statusCode(200)
      .body("data.updateAccountPicture.name", is("Dieter Dubinsky"))
      .body("data.updateAccountPicture.picture", startsWith("data:image/png;base64,iVBORw0KGgoAAAANS"));
  }

  @Test
  @Transactional
  public void testUpdateMyAccountPicture()
  {
    given()
      .when()
      .auth().oauth2(getDubinskysToken())
      .body(getGraphQLBody("graphql/UpdateMyAccountPicture.graphql"))
      .post("/graphql")
      .then()
      .statusCode(200)
      .body("data.updateMyAccountPicture.name", is("Dieter Dubinsky"))
      .body("data.updateMyAccountPicture.picture", startsWith("data:image/png;base64,iVBORw0KGgoAAAANS"));
  }
